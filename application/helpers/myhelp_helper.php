...
*/
	...
	function fixedcountry(){
		...
		return array('USA','Canada','Mexico','England','Germany','France','Australia','Switzerland','Singapore','Malaysia','Korea','China','Japan','Italy','Netherlands','Ireland','India','Bangladesh');
		
	}

	function getCountryISOCodeByCountryName($country) {
		$countries = array(
			"AF"=>"Afghanistan",
			"AL"=>"Albania",
			"DZ"=>"Algeria",
