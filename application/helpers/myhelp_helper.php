...
*/
	...
	if (!function_exists('getUSstates')) {
	...
	if (!function_exists('getUScitiesByState')) {
		function getUScitiesByState($stateISOcode) {
			$USAcitiesByStates = array(
			    'AL' => array(
			        'Abbeville',
			        'Adamsville',
			        'Addison',
			...
			if (array_key_exists($stateISOcode, $USAcitiesByStates))
				return $USAcitiesByStates[$stateISOcode];
			else
				return [];
		}
	} // end if
	...
	if (!function_exists('getCountryISOCodeByCountryName')) {
