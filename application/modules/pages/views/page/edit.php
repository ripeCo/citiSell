                                    ...
                                    <div class="col-md-5">
										...
										<select id="e2" style="width:380px" name="pagename" required="required" class="populate placeholder">
											...
											<optgroup label="Page Name">
												<option <?php if($pagename == 'about'){echo 'selected="selected"'; } ?> value="about"> About <?php echo sitename(); ?> </option>
												
												<option <?php if($pagename == 'ppolicy'){echo 'selected="selected"'; } ?> value="ppolicy"> Privacy Policy</option>
												
												<option <?php if($pagename == 'terms'){echo 'selected="selected"'; } ?> value="terms"> Terms & Conditions</option>
												
												<option <?php if($pagename == 'faq'){echo 'selected="selected"'; } ?> value="faq"> FAQS</option>
											<optgroup>
										</select>
