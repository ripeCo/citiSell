												...
												<td class="td-center">
													...
													<div class="input-group-btn">
														...
														<ul class="dropdown-menu pull-right" role="menu">
															...
															<li>
																<a href="<?php echo base_url(); ?><?php echo $this->uri->segment(1).'/'.$this->uri->segment(2).'/edit/'.$result->PortalUId; ?>">
															...
															<li class="divider"></li>
															<li>
																<a onclick="return confirmDelete();" href="<?php echo base_url();?><?php echo $this->uri->segment(1).'/'.$this->uri->segment(2).'/delete/'.$result->PortalUId; ?>">
