                            ...
                            <table  class="display table table-bordered table-striped" id="dynamic-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="th-center">Sub Category Name</th>
                                ...
                                ?>
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td class="td-center"><?php echo $result->sub_category_name; ?></td>
                                        <td class="td-center">

                                            <?php if( $result->sub_cat_status == 1 ){ ?>
                                        ...
                                        <td class="td-center">
                                            ...
                                            <div class="input-group-btn">
                                                ...
                                                <ul class="dropdown-menu pull-right" role="menu">
                                                    ...
                                                    <li>
                                                        <a href="<?php echo base_url(); ?><?php echo $this->uri->segment(1).'/'.$this->uri->segment(2).'/subcatupdate/'.$result->sub_category_id; ?>">
                                                    ...
                                                    <li class="divider"></li>
                                                    <li>
                                                        <a onclick="return confirmDelete();" href="<?php echo base_url();?><?php echo $this->uri->segment(1).'/'.$this->uri->segment(2).'/delete/'.$result->sub_category_id; ?>">
