                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <h5 style="position:relative;top:10px;right: 100px;">
                            <a class="btn btn-primary pull-right" href="<?php echo base_url(); ?><?php echo $this->uri->segment(1).'/'.$this->uri->segment(2).'/addsubcat'; ?>">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal" id="signupForm0" method="post" action="<?php echo base_url(); ?>categorymanagement/subcategory/updatesubcat/<?php echo $sub_category_id; ?>">
                                    ...
                                    <div class="form-group ">
                                        <label for="SubCategoryName" class="control-label col-lg-3">Sub Category Name :</label>
                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                            <input class=" form-control" required="required" id="SubCategoryName_old" name="SubCategoryName_old" type="hidden" value="<?php echo $sub_category_name; ?>" />
                                            <input class=" form-control" required="required" id="SubCategoryName" name="SubCategoryName" type="text" value="<?php echo $sub_category_name; ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        <label for="SubCatStatus" class="control-label col-lg-3 col-sm-3">Status :</label>
                                        <div class="col-lg-6 col-sm-9">
                                            <?php if($sub_cat_status == 1){ ?>
                                                <input  type="checkbox" style="width: 20px" checked="checked" class="checkbox form-control" id="SubCatStatus" name="SubCatStatus" />
                                            <?php }else{ ?>
                                                <input type="checkbox" style="width: 20px" class="checkbox form-control" id="SubCatStatus" name="SubCatStatus" />
                                            <?php } ?>
                                        </div>
                                    </div>
