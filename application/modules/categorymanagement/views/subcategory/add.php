                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal" id="signupForm0" method="post" action="<?php echo base_url(); ?>categorymanagement/subcategory/save">
									...
									<div class="form-group ">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                            <input class=" form-control" required="required" id="SubCategoryName" name="SubCategoryName" type="text" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        <label for="SubCatStatus" class="control-label col-lg-3 col-sm-3">Sub Category Status :</label>
                                        <div class="col-lg-6 col-sm-9">
                                            <input  type="checkbox" checked="checked" style="width: 20px" class="checkbox form-control" id="SubCatStatus" name="SubCatStatus" />
                                        </div>
                                    </div>
