                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>administrator/shops/shopupdate/<?php echo $shopid; ?>">
                                    ...
                                    <div class="form-group ">
                                        <label for="gplus" class="control-label col-lg-3">Shop Status :</label>
                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                            
											<select name="shop_status" required class="form-control" style="width:150px;">
                                                
                                                <option <?php if($this->uri->segment(3) == 'active'){ echo 'selected="selected"'; } ?> value="Active">Active</option>
                                                <option <?php if($this->uri->segment(3) == 'suspend'){ echo 'selected="selected"'; } ?> value="Suspended">Suspend</option>
                                            </select>
