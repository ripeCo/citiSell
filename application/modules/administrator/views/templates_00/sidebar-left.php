    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu ">
                    <a href="javascript:;" class="dcjq-parent <?php if($this->uri->segment(2) === 'category'){ echo 'active'; } ?>">
                    ...
                    <ul class="sub">
                        ...
                        <!-- Sub Category -->
                        <li><a href="<?php echo base_url(); ?>categorymanagement/subcategory/add"><i class="fa fa-plus"></i>&nbsp;Add New Subcategory</a></li>
                        <li><a href="<?php echo base_url(); ?>categorymanagement/subcategory"><i class="fa fa-eye"></i>&nbsp;View Sub Category lists</a></li>

                        <!-- Sub Category Lev2 -->
                        <li><a href="<?php echo base_url(); ?>categorymanagement/subcategory2/add"><i class="fa fa-plus"></i>&nbsp;Add New Subcategory 2</a></li>
