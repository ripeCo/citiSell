	...
	<div class="modal fade loggin" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
	  <div class="modal-dialog modal-md" role="document">
		...
		<div class="modal-content">
			<div class="signin_details"><!-- Begin: register_details -->
			  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<form class="form-horizontal" id="signinfrm" method="post">
					<!--<div class="faildd">
						<span class="fldtt">Incorrect email OR Password !</span>
					</div>-->
					<div class="successlog">
						<span class="fldtt">Login Success !</span>
					</div>
					<div class="form-group">
						<label for="inputEmail3" class="col-sm-3 control-label">User email</label>
						<div class="col-sm-9">
					...
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-9 col-md-9 col-lg-9">
						  <button type="submit" id="signsub" class="btn btn-info btn-sm custom-button" style="width:40%;">Signin</button>
						</div>
					</div>
				</form>
