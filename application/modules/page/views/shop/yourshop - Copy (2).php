                    	...
                    	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="wizarcontent"><!-- Begin: wizarcontent -->
                                    ...
                                    <div id="step-2" class="row setup-content" style="display: none;">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        	<h3 class="shop_steptitle">Name your shop <span class='text-success'>- <?php echo $shop_name; ?></span></h3>
                    								...
                    								<div class="shopperformance_box"><!-- Begin: shopperformance_box -->
                                                    	...
                                                    	<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 col-lg-offset-1 col-md-offset-1 col-sm-offset-1 col-xs-offset-0">
														   ...
														   <div class="input-group form-group">
															  ...
															  <input type="text" required="required" name="shop_name" id="shop_name" placeholder="Enter your shop name..." class="form-control input-lg inputtxtcheck2" value="<?php echo $shop_name; ?>" />
																							...
																							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                                                <div class="shopfrm_box"><!-- Begin: shopfrm_box -->
																									...
																									<div class="fileUpload">
																										...
																										<input id="uploadBtn1" type="file" name="product-image1" class="upload" />
																									</div>
																									<input id="uploadFile1" placeholder="0 files selected" disabled="disabled" />
                                                                                        	...
                                                                                        	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                                                <div class="shopfrm_box"><!-- Begin: shopfrm_box -->
																									...
																									<div class="fileUpload">
																										...
																										<p class="custom-para">Add a Image</p>
																										<input id="uploadBtn2" type="file" name="product-image2" class="upload" />
																									</div>
																									<input id="uploadFile2" placeholder="0 files selected" disabled="disabled" />
																							...
																							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                                                <div class="shopfrm_box"><!-- Begin: shopfrm_box -->
																									...
																									<div class="fileUpload">
																										...
																										<p class="custom-para">Add a Image</p>
																										<input id="uploadBtn3" type="file" name="product-image3" class="upload" />
																									</div>
																							<input id="uploadFile3" placeholder="0 files selected" disabled="disabled" />
																									
                                                                                                </div><!-- End: shopfrm_box -->
                                                                                            </div>
																							
                                                                                        	<!--div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                                                <div class="shopfrm_box">
                                                                                                    <a href="#">
                                                                                                      ...
                                                                                                      <div style="margin-top:15px;" class="form-group">
																										...
																										<div class="col-sm-9">
																											...
																											<select name="category" id="category" style="width:30%;float:left;margin-right:7px;" class="form-control">
																												<option>What is category?</option>
																											...
																											<select name="subcategory" id="subcategory" style="width:30%;float:left;margin-right:7px;" class="form-control">
																												<option>What is sub category?</option>
																												<optgroup label="Select a Sub Category">
