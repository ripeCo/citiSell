								...
								<div class="col-sm-9">
									...
									<div class="col-group panel-heading p-xs-2 bb-xs-0 hide-xs">
										...
										<div class="col-xs-3 p-xs-0">
											...
											<input type="text" name="shipping_cost_by_itself" id="shipping_cost_by_itself" data-field="primary_cost" value="" class="form-control" style="padding-left: 48px">USD
												
										</div>
										
										<div class="col-xs-4 p-xs-0">
											
											<input type="text" name="shipping_cost_with_another_items" id="shipping_cost_with_another_items" data-field="secondary_cost" value="" class="form-control" style="padding-left: 48px">USD
