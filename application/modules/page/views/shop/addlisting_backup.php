...
<script type="text/javascript">
	...
	<!-- Input Tag Plugin -->
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/frontend/css/jquery.tagsinput.css" />

	<script type="text/javascript" src="<?php echo base_url(); ?>assets/frontend/js/jquery.tagsinput.js"></script>
	...
	<style type="text/css">
		...
		<input name="tags" id="input-tags1" class="form-control" style="width:100% !important" />
														...
														<div class="row">
															<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
																<div class="input-group0">
																  ...
																  <input name="materials" id="input-tags2" class="form-control" style="width:100% !important" />
