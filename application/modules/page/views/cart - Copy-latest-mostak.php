                      ...
                      <tbody>
						...
						<?php
							...
							foreach ($cart as $item):
								$get_thumbs = $this->page_model->get_productimgs($item['id']);
                        ...
                        <tr class="cart_content">
							...
							<td style="padding:8px;" align="center">
								<a class="crtimg" href="<?php echo base_url(); ?>page/pdetails/<?php echo str_replace("&","and",strtolower(str_replace(' ', '-', str_replace("'", '', str_replace(',', '', str_replace('/', '', str_replace('(', '', str_replace(')', '', $item['name'])))))))); ?>/<?php echo $item['id']; ?>">
								    <?php
										$sname = str_replace("&","and",strtolower(str_replace(' ', '-', str_replace("'", '', $item['shopname']))));	
								...
								<h6>
									...
									<?php
										if(!empty($item['options']['color'])){
											echo '<b>Color -</b> '. $item['options']['color'];
										}
									
										if(!empty($item['options']['size'])){
											echo ", &nbsp;&nbsp;".'<b>Size -</b> '. $item['options']['size'];
										}
									?>
							...
							<td align="center" style="padding-top:10px;">
								<?php echo form_input('cart['. $item['id'] .'][qty]', $item['qty'], 'maxlength="3" type="hidden" size="8" style="border:1px solid #ddd;text-align:center;padding:4px 3px;" onchange="update_qty()"'); ?>
