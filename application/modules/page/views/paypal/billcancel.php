            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="whatitem_inner"><!-- Begin: whatitem_inner -->
                    ...
                    <div class="whatitem_more">
						...
						<h2 style="font-size:25px; color:#313131; padding-bottom:8px; text-align: left; font-family: cursive; font-weight:bold;">
							
							Dear <?php echo $this->session->userdata('displayname'); ?>,
							
						</h2>
						
						<span style="color: #f00; font-size:30px; font-family: cursive; text-align: left; left: -40px; position: relative;"> <i class="fa fa-times-circle-o"></i>
							
							We are sorry! Your last outstanding bill payment was cancelled!
							
						</span><br/>
						
						<?php
							/*$pret = "2016-06-27 15:38:38";
