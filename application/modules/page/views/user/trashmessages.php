	 ...
	 <div class="mail-box">
		...
		<aside class="lg-side">
			<div class="inbox-head">
				...
				<h3> <i class="fa fa-inbox"></i> Trash Messages</h3>
				...
				<table width="100%" id="example-table" class="table table-striped table-bordered table-inbox">
					<thead>
						...
						<?php
							...
							$sqlGetReceiver = $this->db->query("select * from mega_message where (receiverid=$receiverid0 OR senderid=$receiverid0) and refid='0' and msgstatus='Delete' order by msgdatetime DESC");
						...
						<tr class="<?php if($msgstatus == 'read'){ echo ''; }else{ echo 'unread';} ?>">
							...
							<td class="view-message <?php if($msgstatus == 'read'){ echo 'msg-show'; }else{ echo 'dont-show';} ?>">
								...
								<a href="<?php echo base_url(); ?>page/user/writemessage/refid/<?php echo $conversationid; ?>/<?php echo $refid; ?>/Delete">
