	 ...
	 <div class="mail-box">
		...
		<aside class="lg-side">
			<div class="inbox-head">
				...
				<h3> <i class="fa fa-inbox"></i> Sent Messages</h3>
			...
			<div class="inbox-body">
				...
				<div class="mail-option">
					...
					<!--div class="btn-group">
						...
						<button type="submit" name="msgarchive" value="Archive" onclick="confirmArchive()" class="btn mini tooltips actv" id="actv2">
				...
				<table width="100%" id="example-table" class="table table-striped table-bordered table-inbox">
					...
					<tbody>
						...
						<?php
							...
							$sqlGetReceiver = $this->db->query("select * from mega_message where senderid=$receiverid0 and refid='0' and msgstatus!='Archive' and msgstatus!='Delete' order by msgdatetime DESC");
							...
							foreach($sqlFetchReceiver as $inboxresults){
								...
								$rrefid  = $inboxresults->conversationid;
								$sqlGetReceiver54 = $this->db->query("select * from mega_message where refid=$rrefid order by msgdatetime DESC");
						...
						<tr class="<?php if($msgstatus == 'read'){ echo ''; }else{ echo 'unread';} ?>">
							...
							<td class="view-message <?php if($msgstatus == 'read'){ echo 'msg-show'; }else{ echo 'dont-show';} ?>">
								...
								<a href="<?php echo base_url(); ?>page/user/writemessage/refid/<?php echo $conversationid; ?>/<?php echo $rrefid; ?>">
							...
							<td class="view-message <?php if($msgstatus == 'read'){ echo 'msg-show'; }else{ echo 'dont-show';} ?> text-right">
								...
								<?php
									/*$time1 = $inboxresults->msgdatetime;
									...
									if($hrs > 24){
										echo $inboxresults->msgdate.'<br/>';
										echo '<i>'. substr($inboxresults->msgdatetime,-9).'</i><br/>';
									}else{
										echo $hrs . " hours.";
									}*/
