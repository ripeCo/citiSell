                ...
                <div class="whatitem_inner"><!-- Begin: whatitem_inner -->
                    ...
                    <?php
                       ...
                       if(isset($success_msg)){
						   ...
						   echo '<h1 id="msg" class="text-primary bg-success pdd5"> <i class="fa fa-check-circle"></i> You are Successfully Registered on CitiSell </h1>';
						  
						   echo '<h3 id="msg" class="text-primary bg-success pdd5"> <i class="fa fa-check-circle"></i> '.$success_msg.' </h3>';
						   
                       }else if(isset($error_msg)){
                           
						   echo '<h3 class="text-danger bg-danger pdd5"> <i class="fa fa-exclamation-triangle"></i> '.$error_msg.' </h3>';
