    ...
    <div class="container">
        ...
        <div class="row">
            <div class="discover_head"><!-- Begin: discover_head -->
            	<h3 class="discover_head_h3">Discover your latest favorites items in <?php echo sitename(); ?></h3>
                	...
                	<div class="row">
                        ...
                        <div class="landscape_main"><!-- Begin: landscape_main -->
                            ...
                            <a href="<?php echo base_url(); ?>page/category/<?php echo str_replace("&","and",strtolower(str_replace(' ', '-', str_replace("'", '', $category_name)))); ?>/<?php echo $category_id; ?>">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="landscape_img home"><!-- Begin: landscape_img -->
										...
										<?php
											...
											for($pd212pi=0;$pd212pi< count($pd212pimg);$pd212pi++){
												...
												echo '<img class="img-responsive img-thumbnail" src="'.$pd212imglocation.'" alt="'.$last2itemsview->product_name.'" />';
												break;
											}
											//echo $category_name;
										?>
