...
class paypal_lib {
	...
	function paypal_lib()
	{
		...
		/*echo $url = $this->CI->uri->segment(3);
	...
	function paypal_auto_form($name,$breadcrumb) 
	{
		...
		echo '<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.6.3/css/font-awesome.css" />';
		...
		echo '<h2 style="position:absolute;color:#7FBA00;"> <i class="fa fa-check-circle"></i> "'. $name .' '.$breadcrumb.'".........</h2>';
		
		//$this->button('Click here if you\'re not automatically redirected...');
		
		echo '<span style="color: #dc4739;font-size: 16px; position: relative;text-align: center;top: 118px;z-index: 1;">Please wait,  "'. $name .' '.$breadcrumb.'" and you will be redirected to the paypal website.</span>' . "\n";
	...
	function paypal_form($form_name='paypal_form') 
	{
		...
		$str .= '<span style="margin: 0 auto !important;overflow: hidden;position: relative;top: 155px; left:178px; width: 300px;"><button type="submit" class="btn btn-success" name="pp_submit"> <i class="fa fa-reply"></i> Click here if you\'re not automatically redirected... </button></span>';
		$str .= form_close() . "\n";
